...
silent only
cd ~/manos/devicehub-teal
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +30 ereuse_devicehub/resources/action/views.py
badd +590 ereuse_devicehub/resources/action/models.py
badd +76 ereuse_devicehub/resources/action/schemas.py
badd +1 ereuse_devicehub/resources/schemas.py
badd +14 ereuse_devicehub/resources/device/schemas.py
badd +449 ereuse_devicehub/resources/device/models.py
badd +3 ereuse_devicehub/resources/models.py
badd +46 ereuse_devicehub/db.py
argglobal
silent! argdel *
$argadd ereuse_devicehub/resources/action/views.py
edit ereuse_devicehub/resources/action/models.py
...
1292
normal! zo
let s:l = 867 - ((54 * winheight(0) + 27) / 55)
