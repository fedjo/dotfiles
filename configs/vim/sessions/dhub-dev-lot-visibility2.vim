...
set shortmess=aoO
badd +1 resources/device/models.py
badd +1 resources/device/schemas.py
badd +136 resources/device/views.py
badd +1 resources/lot/__init__.py
badd +99 resources/lot/models.py
badd +1 resources/lot/schemas.py
badd +89 resources/lot/views.py
badd +1 resources/schemas.py
badd +54 resources/deliverynote/models.py
argglobal
silent! argdel *
$argadd resources/device/definitions.py
$argadd resources/device/exceptions.py
$argadd resources/device/__init__.py
$argadd resources/device/models.py
$argadd resources/device/schemas.py
$argadd resources/device/search.py
$argadd resources/device/states.py
$argadd resources/device/sync.py
$argadd resources/device/views.py
$argadd resources/lot/__init__.py
$argadd resources/lot/models.py
$argadd resources/lot/schemas.py
$argadd resources/lot/views.py
$argadd resources/schemas.py
$argadd resources/deliverynote/models.py
edit resources/deliverynote/models.py
...
argglobal
if bufexists('resources/deliverynote/models.py') | buffer resources/deliverynote/models.py | else | edit resources/deliverynote/models.py | endif
let s:cpo_save=&cpo
set cpo&vim
...
let s:l = 54 - ((41 * winheight(0) + 38) / 76)
