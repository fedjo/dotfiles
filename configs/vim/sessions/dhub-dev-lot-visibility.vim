...
edit resources/device/schemas.py
...
argglobal
if bufexists('resources/device/schemas.py') | buffer resources/device/schemas.py | else | edit resources/device/schemas.py | endif
let s:cpo_save=&cpo
set cpo&vim
